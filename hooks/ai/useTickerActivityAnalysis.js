/**
 * Hook personnalisé pour l'analyse LLM de l'activité complète d'un ticker
 */

import { useState, useEffect, useCallback } from "react";
import intelligenceClient from "/lib/api/intelligenceClient";

export function useTickerActivityAnalysis(ticker, options = {}) {
...
export default useTickerActivityAnalysis;
