...
function OIPerStrikeTicker({ ticker = "", date = "" }) {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        const response = await unusualWhalesClient.getStockOIPerStrike(ticker, params);
        ...
        console.error("Error loading OI per strike:", err);
      ...
      <MDBox p={3}>
        <MDBox display="flex" justifyContent="space-between" alignItems="center" mb={2}>
          <MDTypography variant="h6">
            OI per Strike ({ticker}) ({data.length})
          </MDTypography>
          <Tooltip title="Open interest total pour les calls et puts par strike price">
          ...
          <TableContainer>
            <Table size="small">
              <MDBox component="thead">
                <TableRow>
                  <DataTableHeadCell width="20%" align="left">Strike</DataTableHeadCell>
                  <DataTableHeadCell width="20%" align="right">Call OI</DataTableHeadCell>
                  <DataTableHeadCell width="20%" align="right">Put OI</DataTableHeadCell>
                  <DataTableHeadCell width="20%" align="right">Total OI</DataTableHeadCell>
