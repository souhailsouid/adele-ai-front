...
function PoliticianTrades({ data = [], loading = false }) {
  ...
  const getIssuerLabel = (issuer) => {
    ...
    if (iss === "not-disclosed" || iss === "undisclosed") return "Non divulgué";
    return issuer;
  };
      ...
      <MDBox p={3}>
        <MDBox display="flex" justifyContent="space-between" alignItems="center" mb={2}>
          <MDTypography variant="h6">
            Politician Trades ({data.length})
          </MDTypography>
          <Tooltip title="Transactions récentes des politiciens">
        ...
        {data.length === 0 ? (
          <MDTypography variant="body2" color="text">
            Aucune transaction de politicien disponible
          </MDTypography>
        ) : (
          <TableContainer>
            <Table size="small">
              <MDBox component="thead">
                <TableRow>
                  ...
                  <DataTableHeadCell width="18%" align="left">Politicien</DataTableHeadCell>
